...
SG.EVENTS = [
  ...
  { id: 'polyspike', title: 'Polysilicon spot price spikes', station: null, priceMult: { poly: 1.8, ingot: 1.2 }, days: 60,
    text: 'Solar demand outruns polysilicon supply and the spot price jumps. Most of the world\'s polysilicon goes to solar, and the electronic-grade chunks you make sell into the same swings; a producer with surplus poly earns the most right now. (Module 01)' },
  { id: 'polycrash', title: 'Polysilicon glut', station: null, priceMult: { poly: 0.45 }, days: 60,
    text: 'New Chinese polysilicon capacity floods the market and the spot price collapses below many producers\' cost, as it did in 2023–24. Surplus poly is worth little; the chain\'s value is downstream. (Module 01)' },
